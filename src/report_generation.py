...
def main():
    ...
    # 4. Define the Tasks with Strict Formatting Guidelines
    ...
    task_final_brief = Task(
        description=(
            ...
            "Structure the output in beautiful, industry-standard Markdown. "
        ...
        expected_output="A polished Markdown report saved as results/emergency_operations_brief.md with perfect syntax and no visible raw markdown tokens.",
